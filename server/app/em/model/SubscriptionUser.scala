...
case class SubscriptionUser(id: Option[Int], endpoint: String, keyAuth: String, keyp256dh: String, userFk: Int, deviceDescription: String) extends HasCopy[SubscriptionUser, Int] {
